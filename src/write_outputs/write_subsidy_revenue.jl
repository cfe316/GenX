...
@doc raw"""
	write_subsidy_revenue(path::AbstractString, inputs::Dict, setup::Dict, dfCap::DataFrame, EP::Model)
...
"""
function write_subsidy_revenue(path::AbstractString, inputs::Dict, setup::Dict, dfCap::DataFrame, EP::Model)
	dfGen = inputs["dfGen"]
	G = inputs["G"]
